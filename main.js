...
recognition.onresult = function(event)
{
    ...
    document.getElementById("status").innerHMTL = "A fala foi reconhecida como: " + content;
    if(content == "círculo")
    {
...
/* Escrever a function draw() para desenhar a forma na tela. 
***Math.floor() é usado para arredondar o número inteiro mais próximo
 em direção ao valor menor.*/
